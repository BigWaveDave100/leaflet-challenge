...
legend.onAdd = function(myMap) {
    let div = L.DomUtil.create("div","info legend")
        ...
        div.innerHTML += '<i style="background: green"></i><span>(10 < Depth <= 20)</span><br>';
        div.innerHTML += '<i style="background: orange"></i><span>(20 < Depth <= 30)</span><br>';
        div.innerHTML += '<i style="background: red"></i><span>(30 < Depth <= 40)</span><br>';
        div.innerHTML += '<i style="background: blue"></i><span>(40 < Depth <= 50)</span><br>';
        div.innerHTML += '<i style="background: purple"></i><span>(50 < Depth <= 60)</span><br>';
        div.innerHTML += '<i style="background: black"></i><span>(Depth > 60)</span><br>';
    return div;
};
legend.addTo(myMap);
